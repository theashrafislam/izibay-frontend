...
const FeaturedProductCard = ({ product }) => {
    return (
        <div className="flex flex-col rounded-xl justify-between w-full md:w-56 lg:w-60 xl:w-64 2xl:w-72 h-[350px] sm:h-[380px] md:h-[400px] bg-white shadow-md hover:shadow-lg transition-shadow duration-300">
            {/* Product Image */}
