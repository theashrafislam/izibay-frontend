...
const Button = ({ icon, name, color }) => {
    return (
        <div className={`transition w-full`}>
            <button className={`w-full text-sm lg:text-lg text-nowrap ${icon ? 'flex items-center justify-center gap-1' : ""} rounded-full font-semibold capitalize px-4 lg:px-7 transition py-3
